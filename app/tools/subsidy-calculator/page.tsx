...
export const metadata: Metadata = {
  title: "우리집 지원금 진단",
  description:
    "나이, 가구원수, 소득, 상황을 체크하면 해당 가능성이 있는 대표 정부지원제도를 진단해드립니다.",
};

export default function SubsidyCalculatorPage() {
  return (
    <div className="mx-auto max-w-2xl px-4 py-12">
      <h1 className="text-xl font-bold mb-2 text-ink">🔍 우리집 지원금 진단</h1>
      <p className="text-sm text-ink-soft mb-8">
        3단계 체크만 하면 해당 가능성이 있는 대표 지원제도를 진단해드립니다. 정확한 자격은
